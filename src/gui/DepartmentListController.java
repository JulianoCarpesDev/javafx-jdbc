...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	public void onNewAction(ActionEvent event) {
		Stage parentStage = Util.currenstage(event);
	...
	private void initEditButtons() {
		...
		tableColumnEDIT.setCellFactory(param -> new TableCell<Department, Department>() {
			...
			protected void updateItem(Department obj, boolean empty) {
				...
				setGraphic(button);
				button.setOnAction(event -> createDialogForm(obj, "/gui/DepartmentForm.fxml", Util.currenstage(event)));
			}
	...
	Optional<ButtonType>result= Alerts.showConfirmation("Conrfirmation", "Are you sure to delete?");
